...
public class TaskController {
	...
	String assignTaskToMaintenance(@PathVariable("maintenanceId") int maintenanceId,
	...
	// http://localhost:8072/task-service/task/mId/109
	@GetMapping("/task/mId/{maintenanceId}")
	List<Task> maintenanceById(@PathVariable("maintenanceId")int maintenanceId) {
