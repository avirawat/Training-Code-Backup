...
public class TaskServiceImpl implements ITaskService {
	...
	@Override
	public List<Task> getByMaintenanceId(int maintenanceId) throws TaskNotFoundException {
		return taskRepository.findByMaintenanceId(maintenanceId);
	}
//	
//	@Override
//	public Maintenance maintenanceById(int maintenanceId) {
//		String url = BASEURL2 + "/maintenance/" + maintenanceId;
//		ResponseEntity<Maintenance>maintenance=restTemplate.getForEntity(url,Maintenance.class);
//		return maintenance.getBody();
//	}
//
//	@Override
//	public int assignTask(int maintenanceId, int taskId) {
//		
//		return 0;
//	}
