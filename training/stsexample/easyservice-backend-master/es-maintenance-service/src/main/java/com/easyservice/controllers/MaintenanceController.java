...
public class MaintenanceController {
	...
	// http://localhost:8071/maintenance-service/maintenance/mId/101
	@DeleteMapping("/maintenance/mId/{maintenanceId}")
	...
	String assignMaitenanceToContract(@PathVariable("maintenanceId") int maintenanceId,
	...
	//http://localhost:8071/maintenance-service/maintenance/maintenanceId/101
//	List<Task> getAllTaskByMaintenanceId(@PathVariable("maintenanceId")int maintenenceId){
//		return maintenanceService.getAllTask(maintenenceId);
//	}
