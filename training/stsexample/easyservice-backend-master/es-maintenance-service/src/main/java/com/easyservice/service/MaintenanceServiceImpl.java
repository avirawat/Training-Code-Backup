...
//	@Override
//	public int updateStatus(Status mStatus, int maintenanceId) {
//		return maintenanceRepository.updateStatus(Status.INPROGRESS, maintenanceId);
//	}

	@Override
	public int assignMaitenanceToContract(int maintenanceId, int contractId) {
		//updateStatus(Status.INPROGRESS, maintenanceId);
		return maintenanceRepository.assignMaintenanceToContract(contractId, maintenanceId);
	}

//	@Override
//	public List<Task> getAllTask(int maintenanceId) {
//		return maintenanceRepository.findAllTaskByMaintenanceId(maintenanceId);
//	}
